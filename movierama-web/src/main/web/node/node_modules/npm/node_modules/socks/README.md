...
```typescript
{
  proxy: {
    ...
    // Optional fields
    postedByUserId: 'some username', // Used for SOCKS4 postedByUserId auth, and SOCKS5 user/pass auth in conjunction with password.
    password: 'some password' // Used in conjunction with postedByUserId for user/pass auth for SOCKS5 proxies.
  },
